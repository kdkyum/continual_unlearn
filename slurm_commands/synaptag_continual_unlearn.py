...
"""
Script to generate a Slurm job for running the synaptag algorithm on CIFAR-10
...
def parse_args():
    parser = argparse.ArgumentParser(description='Generate Slurm script for cumulative synaptag unlearning')
    parser.add_argument('--save_dir', type=str, default="checkpoints/synaptag_continual_unlearn",
    ...
    parser.add_argument('--job_name', type=str, default="synaptag_continual_unlearn",
...
def generate_slurm_script(args):
    ...
    script_path = f"{args.output_dir}/synaptag_cumulative_unlearn_{timestamp}.sh"
...
def main():
    ...
    print(f"Generating Slurm job for cumulative synaptag unlearning of classes 0-{args.max_classes-1}...")
